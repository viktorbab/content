...
=======
    MODELING_RULE_COMPONENT_FILES, ONLY_INSTALL_PACK_FILE_TYPES, SANITY_TEST_TO_PACK,
    SKIPPED_CONTENT_ITEMS__NOT_UNDER_PACK, XSOAR_SANITY_TEST_NAMES)
>>>>>>> 411af81bfe (feat(collect_tests): implement marking of modeling rules for testing during test collection)
